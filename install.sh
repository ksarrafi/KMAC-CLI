...
for script in _ui.sh _vault.sh _auth-helper.sh _ai-fix.sh _hooks.sh _platform.sh _pilot-lib.sh _pilot-bot.sh ask review aicommit sessions project cursoragent claudeme killport pilot server remote-access dotbackup update-check toolmaker secrets setup-mac release software ollama-setup docker docker-health storage remote-terminal.sh tron aicoder install-aicoder create-aicoder.sh; do
...
for script in aicoder claudeme remote-terminal.sh ask review aicommit sessions project cursoragent killport pilot server remote-access dotbackup update-check toolmaker secrets setup-mac release software ollama-setup tron; do
